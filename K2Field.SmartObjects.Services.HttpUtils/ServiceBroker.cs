...
namespace K2Field.SmartObjects.Services.HttpUtils
{
    public class ServiceBroker : ServiceAssemblyBase
    {
        ...
        {
            base.Service.Name = "HttpUtilities";
            base.Service.MetaData.DisplayName = "HTTP Utilities";
            base.Service.MetaData.Description = "Http Utilities";
        ...
        public override string GetConfigSection()
        {
            ...
            Service.ServiceConfiguration.Add("BaseUrl", false, "https://na16.salesforce.com");
